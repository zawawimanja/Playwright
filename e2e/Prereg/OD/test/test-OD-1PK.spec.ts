...
test("Prereg PK OD", async ({ page }) => {
  ...
  await preregPage.fillIdentificationNo("751018085151");
  ...
  await calendarPage.selectDateInsuredPersonPage("2021", "5", "10");

  await page1.getByRole("textbox").nth(2).click();
  await calendarPage.selectDateMCEndDate("2021", "5", "29");
