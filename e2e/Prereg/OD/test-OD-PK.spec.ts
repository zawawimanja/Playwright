...
test("Prereg PK OD", async ({ page }) => {
  ...
  await preregPage.fillIdentificationNo("850304015916");
  ...
  await calendarPage.selectDateInsuredPersonPage("2021", "1", "10");
  ...
  await calendarPage.selectDateInsuredPersonPage("2021", "2", "10");

  await page1.getByRole("textbox").nth(2).click();
  await calendarPage.selectDateMCEndDate("2021", "3", "20");
