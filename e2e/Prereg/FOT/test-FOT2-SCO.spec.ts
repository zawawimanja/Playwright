...
test('Prereg SCO FOT', async ({ page }) => {
  ...
  await page2
    .getByRole('button', { name: 'Confirmation of Dependent/' })
    .click();
  ...
  await page2
    .locator('[id^="_WhethertheinsuredpersonisanemployeeundertheSOCSOAct-"]')
    .first()
    .selectOption('1');
  await page2
    .locator('[id^="_WhethertheSOCSOActappliestothisindustry-"]')
    .first()
    .selectOption('1');
  await page2
    .locator('[id^="_Whetherthepersonalinjuryiscausedbyanaccident-"]')
    .first()
    .selectOption('1');
  await page2
    .locator('[id^="_Whethertheaccidentisinthecourseofhisheremploymentc-"]')
    .first()
    .selectOption('1');
  await page2
    .locator('[id^="_Whethertheaccidentarisedoutofhisemployment-"]')
    .first()
    .selectOption('1');
