...
export class InvalidityInfoPage {
  private page: Page;
  ...
  get insuredPersonEmployment() {
    return this.page.getByLabel("Is the Insured Person Still");
  }
  ...
  async selectInsuredPersonEmployment(text) {
    await this.insuredPersonEmployment.selectOption(text);
  }

  async clickInvalidityInformation() {
    await this.iinvalidityinformationButton.click();
  }

  get iinvalidityinformationButton() {
    return this.page.getByRole("button", { name: "Invalidity Information" });
  }
}
