...
export class Contribution56Page {
  private page: Page;
  ...
  get contribution56Button() {
    return this.page.getByRole("button", { name: "Contribution" });
  }
  ...
  async clickContribution56Button() {
    await this.contribution56Button.click();
  }
